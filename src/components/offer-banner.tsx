    ...
    <section className="max-w-[1400px] mx-auto px-4 md:px-12">
      <div className="relative rounded-[32px] overflow-hidden bg-gradient-to-r from-primary to-on-primary-fixed-variant p-12 lg:p-20 flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="relative z-10 space-y-6 text-on-primary max-w-2xl text-center lg:text-right">
          <div className="inline-block px-6 py-2 bg-on-primary text-primary rounded-full font-bold text-xl shadow-lg">عروض نهاية العام</div>
          <h2 className="text-5xl lg:text-7xl font-bold leading-tight">خصومات تصل إلى 60% على جميع العطور</h2>
          <p className="text-xl opacity-90 leading-relaxed">اكتشف مجموعتنا الحصرية من الروائح الشرقية والفرنسية بأسعار لا تقبل المنافسة. العرض ساري لفترة محدودة جداً.</p>
          <button className="px-10 py-5 bg-on-primary text-primary rounded-xl font-bold text-xl hover:scale-105 active:scale-95 transition-all shadow-2xl">تسوق العروض الآن</button>
        </div>
        <div className="relative z-10 w-full lg:w-1/2 flex justify-center">
          <div className="w-full max-w-sm aspect-square bg-white/10 backdrop-blur-md rounded-[40px] p-8 border border-white/20 shadow-2xl rotate-3 group hover:rotate-0 transition-transform duration-500">
            <div
              ...
              style={{
                backgroundImage: "url('https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&q=80')",
